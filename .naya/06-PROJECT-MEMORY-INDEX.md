...
### Brand / acquisition / content experience
...
- `.naya/memory/21-PRO-MAX-BUTTON-AND-PLAYER-STANDARD.md` — Black Diamond Royal button system, tactile premium controls, hierarchy, interaction states, accessibility, and Pro Max Player launch quality.
...
- Results experience specification
- Naya roles and capabilities
- Brand/content rules
- Deployment and infrastructure
- Known constraints and lessons
- Release history
- AI-to-AI learning and operating wisdom

## MEMORY RULE
Conversation is temporary. Repository memory is durable.
A decision that is important enough to affect future work should be written down.
