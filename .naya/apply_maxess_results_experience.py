...
if tail.strip():
    ...
    # Normalize trailing whitespace without rewriting the document unnecessarily.
    updated = updated[:html_close + len('</html>')] + '\n'

# The only real document boundaries must be the first HTML/body pair. We use
# structural positions rather than raw substring counts because JavaScript may
# legitimately contain tag-like strings in diagnostics.
positions = {
...
for required_fragment in ['YOUR AI SCORE','naya-report','your-dimensions','biggest-lever','naya-masters','naya-human-bridge','naya-final-solution',MARKER_V2,MARKER_V3,MARKER_V4,MARKER_V5,'THE HUMAN + AI SYSTEM']:
